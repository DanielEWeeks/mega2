...
analysis_types analysis_list[] = {
    ...
    { "Mendel {Vintage} format",    TO_MENDEL },
    { "ASPEX format",               TO_ASPEX },
    { "GeneHunter-Plus format",     TO_GeneHunterPlus },
    { "GeneHunter format",          TO_GeneHunter },
    { "{DISABLED} APM format",      TO_APM },
    { "{DISABLED} APM-MULT format", TO_APM_MULT },
    ...
    { "SAGE {Old} format",          TO_SAGE },
    { "{DISABLED} TDTMax analyses", TO_TDTMAX },
