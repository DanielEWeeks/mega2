...
mega2=Mega2GenABEL("tstGNA/mome/mome", ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
...
mega2=Mega2GenABEL("tstGNA/tst/tst", ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
mega =Mega2ENVGenABEL(ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
Mega2GenABELtst(mega,mega2)
...
mega2=Mega2GenABEL("tstGNA/m15k/m15k", ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
mega =Mega2ENVGenABEL(ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
Mega2GenABELtst(mega,mega2)
...
mega2=Mega2GenABEL("tstGNA/yj/yj1", ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
mega =Mega2ENVGenABEL(ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
Mega2GenABELtst(mega,mega2,FALSE)

print("yj2")
ENV=read.Mega2DB("~/mega2/data/yj2.db", verbose = FALSE)
mega2=Mega2GenABEL("tstGNA/yj/yj2", ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
mega =Mega2ENVGenABEL(ENV$markers[ENV$markers$chromosome != 999,], envir = ENV)
Mega2GenABELtst(mega,mega2,FALSE)
print("################################################################")
