...
will lookup the value of **ENV** in the global environment.
...
identifies one useable transcript with several markers: (It is useable 
...
The genotypes for these markers, along with data frame of thesemarkers, the range
...
have one p-value less than 0.01 and AK5 and STL7 less than 0.03.
