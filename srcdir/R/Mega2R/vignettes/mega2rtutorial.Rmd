...
There are two ways to compute a function on the genotypes (or markers) in transcripts.
...
and the call back function is evaluated only once.
...
markers argument and the head of the genotype argument, in that
