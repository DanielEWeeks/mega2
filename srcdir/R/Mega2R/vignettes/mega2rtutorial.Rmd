...
If Mega2R, finds GenABEL in your workspace, the functions described
below, Mega2GenABEL() and Mega2ENVGenABEL() will be available.  Otherwise,
the functions will just return NULL.  (In the example below, we use
"require" vs "library" to illustrate this behavior".)
