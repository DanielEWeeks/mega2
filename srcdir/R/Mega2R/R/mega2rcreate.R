...
#               print(paste0("select ", filter, " from ", tbl));
    ...
    if (envir$DBMega2Version != Mega2RVersion && envir$DBMega2Version != 'X.Y.Z') {
        message("NOTE: Mega2R cannot read the Mega2 database because its version (", envir$DBMega2Version, ") is too")
        message("old. Please recreate the database using the current version of Mega2.")
    }
