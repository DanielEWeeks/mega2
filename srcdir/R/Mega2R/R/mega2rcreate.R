...
#               print(paste0("select ", filter, " from ", tbl));
    ...
    if (envir$DBMega2Version != Mega2RVersion && envir$DBMega2Version != 'X.Y.Z') {
        message("NOTE: DBMega2Version(", envir$DBMega2Version, ") of the database is incompatible with the existing Mega2R runtime.")
        message("You should use the database (generated by Mega2) with Mega2R (of the same Mega2 release).")
    }
