...
when needed.  Mega2R also provides functionality for interacting with
the pedgene R package (https://CRAN.R-project.org/package=pedgene) and for interacting with
the GenABEL R package.
Mega2R also provides functionality for writing subsets of the database out into
VCF format files (https://github.com/samtools/hts-specs).
...
The files you will need for this tutorial are provided in this R
...
To run any of these exercises, you should install the R package `mega2r`.
...
If you wish to use any of the Mega2R functions described here, you will initially have to run Mega2 to convert your data into an SQLite database.
...
transcript.
These examples are explained more thoroughly in Section 6 below.)
...
# 7 Outputting Mega2R data to VCF format
...
## 7.1 Writing a VCF File using the mega2r R package
...
# 8 Converting Mega2R data to GenABEL format
...
## 8.1 Creating a GenABEL gwaa.data-class object using the mega2r R package
...
Then we dump the GenABEL data as
...
Note: We have provided a copy of the srdta.db database in this R package.  So
...
The Mega2 C++ program and this Mega2R R package are both open source and are freely available, along with extensive documentation, from our https://watson.hgen.pitt.edu/register web site. This work was supported by NIH grant R01 GM076667 (PI: Weeks). Earlier contributions to our code base were made by Nandita Mukhopadhyay, Lee Almasy, Mark Schroeder, and William P. Mulvihill.
