...
If you have a executable copy of Mega2, you can run this code using
...
directory.  
Cut and paste the shell code (below) and you should see similar results to what
is presented here.
...
The output should be (except for timestamps):
